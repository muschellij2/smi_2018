...
- Not much different than Python 
    - scikit-learn/ Nipype
- Neural Networks 
- BME have tools to do advanced statistical analysis
...
- More complex study designs are coming/here
  - multiple visits  
  - multi-sequence + multi-modal
...
<div id = "left_col" style="font-size=25pt">
- Add a second/multiple visits
  - independent registration to the template?
  - register to first time point?
- Random effects can be extended
  - but what about different tasks
...
<img src="figure/Reg_Figure_Option1_short_within2.png" style="width:50%">
